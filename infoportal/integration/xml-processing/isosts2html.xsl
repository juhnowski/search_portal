...
<xsl:stylesheet version="2.0"
  ...
  <xsl:output encoding="UTF-8" omit-xml-declaration="yes" method="xhtml" indent="no"/>
...
<!-- Параметр не используется, т.к. нет в исходном *.xml -->
  ...
  <xsl:template match="ref-list[@content-type='bibl' or ancestor::ref-list[@content-type='bibl']]">
    <div class="sts-section sts-ref-list">
      ...
      <xsl:for-each select="p[following-sibling::ref]">
        <p class="sts-p">
          <xsl:apply-templates/>
        </p>
      </xsl:for-each>
...
<!-- ============================================================= -->  
  ...
  <xsl:template match="fig">
    <div class="sts-{local-name()} {@position}" id="{@id}">
...
<!-- ============================================================= -->
<!--  SVG https://stackoverflow.com/questions/39514406             -->
<!-- ============================================================= -->
